...
Mia DevOps **must** follow every file linked below before mutating code, canonical specs, or systems.
...
| [**AUDIT_LOG_AND_OBSERVABILITY.md**](./AUDIT_LOG_AND_OBSERVABILITY.md) | **Reference:** where **sessions / logs / Git** record what Mia DevOps did; how admins **review** |
