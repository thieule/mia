# Documentation updates and completion checklist (Mia DevOps)
...
Teams may extend this list in their own template; Mia DevOps **must not** claim **done** with empty or missing sections when work was non-trivial.
