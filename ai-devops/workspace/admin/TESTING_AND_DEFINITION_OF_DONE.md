# Unit tests, pytest, and definition of “done” (Mia DevOps)

**Status:** Human-maintained policy under `admin/`. Mia DevOps **must read and follow** this file. It **must not** edit files in `admin/` without an approved workflow.

---

## 1. Purpose

Every **code change** that Mia DevOps introduces or materially edits must ship with **automated tests**, and **pytest must be executed** before the assistant tells the user the work is **done**, **complete**, or equivalent.
