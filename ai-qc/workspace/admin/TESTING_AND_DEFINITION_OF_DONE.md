# Unit tests, pytest, and definition of “done” (Mia QC)
...
Every **code change** that Mia QC introduces or materially edits must ship with **automated tests**, and **pytest must be executed** before the assistant tells the user the work is **done**, **complete**, or equivalent.
