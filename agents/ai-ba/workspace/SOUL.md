...
- **Story Interaction:** Reply directly on story threads using `agile_comment_create` rather than group channels. Stay silent on story threads if the user uses random test strings or if Mia Tech is explicitly @mentioned.
