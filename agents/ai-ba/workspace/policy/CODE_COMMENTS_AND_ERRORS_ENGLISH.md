...
**Status:** Human-maintained policy under `policy/`. Mia BA **must read and follow** this file when writing or editing **code** or **repository documentation** covered below. It **must not** edit files in `policy/` without an approved workflow.
