...
class SkillsLoader:
    ...
    def _parse_skill_metadata(self, raw: str) -> dict:
        """Parse skill metadata JSON from frontmatter (mia; legacy mia; openclaw)."""
        try:
            data = json.loads(raw)
        ...
        if not isinstance(data, dict):
            return {}
        payload = data.get("mia", data.get("a_agent", data.get("openclaw", {})))
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get mia metadata for a skill (cached in frontmatter)."""
