...
from mia.utils.helpers import ensure_dir, estimate_message_tokens, estimate_prompt_tokens_chain, strip_think

from mia.agent.runner import AgentRunSpec, AgentRunner
from mia.agent.tools.registry import ToolRegistry
from mia.utils.gitstore import GitStore
...
class Dream:
    ...
    def _build_tools(self) -> ToolRegistry:
        ...
        from mia.agent.tools.filesystem import EditFileTool, ReadFileTool
