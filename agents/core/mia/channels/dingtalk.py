...
class DingTalkStreamHandler(CallbackHandler):
    """
    Standard DingTalk Stream SDK Callback Handler.
    Parses incoming messages and forwards them to the DingTalk channel.
    """
    ...
    async def process(self, message: CallbackMessage):
        ...
        try:
            ...
            # Forward to channel via _on_message (non-blocking).
...
class DingTalkChannel(BaseChannel):
    ...
    async def _on_message(
        ...
        """Handle incoming message (called by DingTalkStreamHandler).
