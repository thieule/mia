...
echo "Core runtime"
echo "------------"
core_agent=$(count_top_level_py_lines "mia/agent")
core_bus=$(count_top_level_py_lines "mia/bus")
core_config=$(count_top_level_py_lines "mia/config")
core_cron=$(count_top_level_py_lines "mia/cron")
core_heartbeat=$(count_top_level_py_lines "mia/heartbeat")
core_session=$(count_top_level_py_lines "mia/session")
...
echo "----------------"
extra_tools=$(count_recursive_py_lines "mia/agent/tools")
extra_skills=$(count_skill_lines "mia/skills")
extra_api=$(count_recursive_py_lines "mia/api")
extra_cli=$(count_recursive_py_lines "mia/cli")
extra_channels=$(count_recursive_py_lines "mia/channels")
extra_utils=$(count_recursive_py_lines "mia/utils")
...
echo "Notes"
echo "-----"
echo "  - agent/ only counts top-level Python files under mia/agent"
echo "  - tools/ is counted separately from mia/agent/tools"
echo "  - skills/ counts .md, .py, and .sh files"
echo "  - not included here: command/, providers/, security/, templates/, facade.py, root files"
