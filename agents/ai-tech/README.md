...
Uses the same **mia** package as other deployments (`../../core` from here), **separate gateway** (default port **18792**), **separate workspace** (`workspace/`), and optional **Discord** bot token `DISCORD_BOT_TOKEN_MIA_TECH`.
...
- **Governance (policy):** [Pre-implementation approval](./workspace/policy/PRE_IMPLEMENTATION_APPROVAL.md) · [Testing & definition of done](./workspace/policy/TESTING_AND_DEFINITION_OF_DONE.md) · [Documentation & completion checklist](./workspace/policy/DOCUMENTATION_AND_COMPLETION_CHECKLIST.md) · [English: code + repo docs](./workspace/policy/CODE_COMMENTS_AND_ERRORS_ENGLISH.md) · [Audit / operations reference](./workspace/docs/OPERATIONS_AUDIT_TRAIL.md) *(not policy)*
...
- **Mia BA** — [../ai-ba/README.md](../ai-ba/README.md): **business analysis** assistant; default gateway **18793** (`agents/ai-ba/`).
- **Mia DevOps** — [../ai-devops/README.md](../ai-devops/README.md): **deploy / infra / ops** assistant; default gateway **18794** (`agents/ai-devops/`).
- **Mia QC** — [../ai-qc/README.md](../ai-qc/README.md): **API + UI / E2E testing**; default gateway **18795** (`agents/ai-qc/`).
