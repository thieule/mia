...
from mia.providers.base import LLMProvider, LLMResponse, ToolCallRequest
from mia.providers.openai_responses import (
    consume_sdk_stream,
    convert_messages,
    convert_tools,
...
if TYPE_CHECKING:
    from mia.providers.registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/floware/mias",
    "X-OpenRouter-Title": "mia",
...
def _uses_openrouter_attribution(spec: "ProviderSpec | None", api_base: str | None) -> bool:
    """Apply mia attribution headers to OpenRouter requests by default."""
