"""MCP client: connects to MCP servers and wraps their tools as native mia tools."""
...
class MCPToolWrapper(Tool):
    """Wraps a single MCP server tool as a mia Tool."""
...
class MCPResourceWrapper(Tool):
    """Wraps an MCP resource URI as a read-only mia Tool."""
...
class MCPPromptWrapper(Tool):
    """Wraps an MCP prompt as a read-only mia Tool."""
