...
from mia.agent.autocompact import AutoCompact
from mia.agent.context import ContextBuilder
from mia.agent.hook import AgentHook, AgentHookContext, CompositeHook
from mia.agent.memory import Consolidator, Dream
from mia.agent.runner import _MAX_INJECTIONS_PER_TURN, AgentRunSpec, AgentRunner
from mia.agent.subagent import SubagentManager
from mia.agent.tools.cron import CronTool
from mia.agent.skills import BUILTIN_SKILLS_DIR
from mia.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
...
from mia.agent.tools.search import GlobTool, GrepTool
from mia.agent.tools.shell import ExecTool
from mia.agent.tools.spawn import SpawnTool
from mia.agent.tools.web import WebFetchTool, WebSearchTool
from mia.bus.events import InboundMessage, OutboundMessage
from mia.command import CommandContext, CommandRouter, register_builtin_commands
...
class _LoopHook(AgentHook):
    ...
    async def on_stream(self, context: AgentHookContext, delta: str) -> None:
        from mia.utils.helpers import strip_think
...
class AgentLoop:
    ...
    async def _connect_mcp(self) -> None:
        ...
        from mia.agent.tools.mcp import connect_mcp_servers
    ...
    def _tool_hint(tool_calls: list) -> str:
        ...
        from mia.utils.tool_hints import format_tool_hints
