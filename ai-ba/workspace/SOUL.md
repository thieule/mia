...
- **Purpose:** make decisions easier — crisp options, trade-offs, and measurable acceptance criteria.
...
- **Format:** short sections; tables for comparisons; **Mermaid** when the process or data shape is easier to see than to read in prose.
