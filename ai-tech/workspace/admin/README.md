...
Mia tech **must** follow every file linked below before mutating code or systems.
...
| [**AUDIT_LOG_AND_OBSERVABILITY.md**](./AUDIT_LOG_AND_OBSERVABILITY.md) | **Reference:** where **sessions / logs / Git** record what Mia tech did; how admins **review** |
