#!/usr/bin/env python3
"""Start the Mia tech deployment (`ai-tech/`): loads .env, installs mia-ai + ai-tools, runs gateway.

Layout (siblings under the repo root):

  core/        # source tree (package mia-ai; runtime imports mia, CLI: python -m mia)
  ai-tools/     # local MCP (registry, pytest_runner, …)
  ai-tech/      # this folder — Mia tech config + workspace + launcher
...
Design drafts, investigation notes, and artefacts the agent may create; subject to `../admin/` policy.
"""
